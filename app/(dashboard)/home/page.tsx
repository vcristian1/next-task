...
// Function to get the project data from the user, we cant add this in the ProjectCard component since this page needs to know how many projects there are to contain.
const getData = async () => {
  await delay(2000);
